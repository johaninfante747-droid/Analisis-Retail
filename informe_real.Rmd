...
kable(caption = "Estadísticas descriptivas de consumo por categoría")
```
...
ggplot(df, aes(x = Age, y = Total.Amount)) +
  ...
  labs(
    ...
    title = "Correlación entre Edad y Gasto"
  )
```
...
ggplot(df_ts, aes(x = Mes, y = Ingresos, group = 1)) + 
  ...
  labs(x = "Meses del Año 2023", y = "Ingresos Totales ($)")
```
...
ggplot(df, aes(x = Rango_Edad, fill = Product.Category)) +
  ...
  theme_minimal() +
  labs(x = "Rango de Edad (Años)", y = "Cantidad de Transacciones", fill = "Categoría") +
